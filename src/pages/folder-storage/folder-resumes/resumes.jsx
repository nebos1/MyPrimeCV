...
function Resumes() {
    ...
    const visibleDocuments = documents.filter((document) => document.type === "resume" && !document.trashed);
        ...
        <div className="workspace-page resumes-page">
            <section className="workspace-content">
                ...
                <WorkspaceDocumentsList
                    ...
                    emptyTitle="Your best CV is waiting to be done"
                    emptyText="Create astonishing CVs that stand out to employers."
                    emptyActionLabel="Create my first CV"

...
import {
    ...
    MoveWorkspaceDocumentToTrash,
    ToggleWorkspaceDocumentFavorite,
} from "../../folder-local-storage/workspace-storage";
import "./motivation-letters.css";
...
function MotivationLetters() {
    ...
    const visibleDocuments = documents.filter((document) => document.type === "motivation-letter" && !document.trashed);
    ...
    function HandleMoveToTrash(documentId) {
        setDocuments(MoveWorkspaceDocumentToTrash(documentId));
    }

    function HandleToggleFavorite(documentId) {
        setDocuments(ToggleWorkspaceDocumentFavorite(documentId));
    }
    ...
    return (
        <div className="workspace-page motivation-letters-page">
            <section className="workspace-content">
                ...
                <WorkspaceDocumentsList
                    ...
                    emptyIcon={Icons.MailLucideIcon}
                    emptyTitle="Your first motivation letter is waiting"
                    emptyText="Create a focused letter for the role and company you are applying to."
                    emptyActionLabel="Create my first motivation letter"
                    onEmptyAction={goToCreateMotivationLetter}
...
export default MotivationLetters;

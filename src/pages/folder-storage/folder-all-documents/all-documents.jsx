...
function AllDocuments() {
    ...
    return (
        <div className="workspace-page all-documents-page">
            <section className="workspace-content">
                ...
                <WorkspaceDocumentsList
                    ...
                    emptyIcon={Icons.FileTextLucideIcon}
                    emptyTitle="A fresh page is waiting"
                    emptyText="Create your first resume or import an editable backup."
                    emptyActionLabel="Create my first resume"
                    onEmptyAction={goToCVTemplates}
            ...
            <section className="sidebar">
                ...
                <div className="sidebar-options">
                    <button type="button" className="all-documents" onClick={goToWorkspace}>
                        ...
                        All documents <small>{count}</small>
                    </button>

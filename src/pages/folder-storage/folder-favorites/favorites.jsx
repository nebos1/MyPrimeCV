...
function Favorites() {
    ...
    const visibleDocuments = documents.filter((document) => document.favorite && !document.trashed);
        ...
        <div className="workspace-page favorites-page">
            <section className="workspace-content">
                ...
                <WorkspaceDocumentsList
                    ...
                    emptyIcon={Icons.HeartLucideIcon}
                    emptyTitle="No favorites yet"
                    emptyText="Use the heart on any document to keep important applications together."
